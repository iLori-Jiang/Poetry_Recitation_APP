...
public class CiReviewWindowController implements Initializable {
    ...
    public CiReviewWindowController() {
    ...
    public void initialize(URL args0, ResourceBundle arg1) {
        ...
        ProgrammeStart.currentUser.studiedCiGradeSorting();

        PageNumber.setText(Integer.toString(CiReviewWindow.currentPage));

        if(ProgrammeStart.currentUser.getUnfinishedCiList().size() >= 5* CiReviewWindow.currentPage-4){
            ReviewSongCi reviewSongCi = ProgrammeStart.currentUser.getUnfinishedCiList().get(5* CiReviewWindow.currentPage-5);
            Title1.setText(reviewSongCi.getRhythmic());
            Author1.setText(reviewSongCi.getAuthor());
            Content1.setText((reviewSongCi.getParagraphs().get(0).substring(0, reviewSongCi.getParagraphs().get(0).length() - 1)) + "......");
            grade1.setText("熟练度：" + Integer.toString(reviewSongCi.grading.get(reviewSongCi.grading.size()-1)));
            studiedTimes1.setText("学习次数" + Integer.toString(reviewSongCi.studiedDays.size()));
            shiORci1 = reviewSongCi.shiOrCi;
            listPosition1 = reviewSongCi.getListPosition();
            poemPosition1 = reviewSongCi.getPositionInList();
        }else{
            Title1.setText("");
            Author1.setText("");
            Content1.setText("");
        ...
        if(ProgrammeStart.currentUser.getUnfinishedCiList().size() >= 5* CiReviewWindow.currentPage-3){
            ReviewSongCi reviewSongCi = ProgrammeStart.currentUser.getUnfinishedCiList().get(5* CiReviewWindow.currentPage-4);
            Title2.setText(reviewSongCi.getRhythmic());
            Author2.setText(reviewSongCi.getAuthor());
            Content2.setText((reviewSongCi.getParagraphs().get(0).substring(0, reviewSongCi.getParagraphs().get(0).length() - 1)) + "......");
            grade2.setText("熟练度：" + Integer.toString(reviewSongCi.grading.get(reviewSongCi.grading.size()-1)));
            studiedTimes2.setText("学习次数" + Integer.toString(reviewSongCi.studiedDays.size()));
            shiORci2 = reviewSongCi.shiOrCi;
            listPosition2 = reviewSongCi.getListPosition();
            poemPosition2 = reviewSongCi.getPositionInList();
        }else{
            Title2.setText("");
            Author2.setText("");
            Content2.setText("");
        ...
        if(ProgrammeStart.currentUser.getUnfinishedCiList().size() >= 5* CiReviewWindow.currentPage-2){
            ReviewSongCi reviewSongCi = ProgrammeStart.currentUser.getUnfinishedCiList().get(5* CiReviewWindow.currentPage-3);
            Title3.setText(reviewSongCi.getRhythmic());
            Author3.setText(reviewSongCi.getAuthor());
            Content3.setText((reviewSongCi.getParagraphs().get(0).substring(0, reviewSongCi.getParagraphs().get(0).length() - 1)) + "......");
            grade3.setText("熟练度：" + Integer.toString(reviewSongCi.grading.get(reviewSongCi.grading.size()-1)));
            studiedTimes3.setText("学习次数" + Integer.toString(reviewSongCi.studiedDays.size()));
            shiORci3 = reviewSongCi.shiOrCi;
            listPosition3 = reviewSongCi.getListPosition();
            poemPosition3 = reviewSongCi.getPositionInList();
        }else{
            Title3.setText("");
            Author3.setText("");
            Content3.setText("");
        ...
        if(ProgrammeStart.currentUser.getUnfinishedCiList().size() >= 5* CiReviewWindow.currentPage-1){
            ReviewSongCi reviewSongCi = ProgrammeStart.currentUser.getUnfinishedCiList().get(5* CiReviewWindow.currentPage-2);
            Title4.setText(reviewSongCi.getRhythmic());
            Author4.setText(reviewSongCi.getAuthor());
            Content4.setText((reviewSongCi.getParagraphs().get(0).substring(0, reviewSongCi.getParagraphs().get(0).length() - 1)) + "......");
            grade4.setText("熟练度：" + Integer.toString(reviewSongCi.grading.get(reviewSongCi.grading.size()-1)));
            studiedTimes4.setText("学习次数" + Integer.toString(reviewSongCi.studiedDays.size()));
            shiORci4 = reviewSongCi.shiOrCi;
            listPosition4 = reviewSongCi.getListPosition();
            poemPosition4 = reviewSongCi.getPositionInList();
        }else{
            Title4.setText("");
            Author4.setText("");
            Content4.setText("");
        ...
        if(ProgrammeStart.currentUser.getUnfinishedCiList().size() >= 5* CiReviewWindow.currentPage){
            ReviewSongCi reviewSongCi = ProgrammeStart.currentUser.getUnfinishedCiList().get(5* CiReviewWindow.currentPage-1);
            Title5.setText(reviewSongCi.getRhythmic());
            Author5.setText(reviewSongCi.getAuthor());
            Content5.setText((reviewSongCi.getParagraphs().get(0).substring(0, reviewSongCi.getParagraphs().get(0).length() - 1)) + "......");
            grade5.setText("熟练度：" + Integer.toString(reviewSongCi.grading.get(reviewSongCi.grading.size()-1)));
            studiedTimes5.setText("学习次数" + Integer.toString(reviewSongCi.studiedDays.size()));
            shiORci5 = reviewSongCi.shiOrCi;
            listPosition5 = reviewSongCi.getListPosition();
            poemPosition5 = reviewSongCi.getPositionInList();
        }else{
            Title5.setText("");
            Author5.setText("");
            Content5.setText("");
    ...
    public void nextPage() throws Exception {
        if(shiORci5 != -1 &&  ProgrammeStart.currentUser.getUnfinishedShiList().size() > 5* ShiReviewWindow.currentPage){
            ...
            CiReviewWindow shiReviewWindow = new CiReviewWindow();
    ...
    public void previousPage() throws Exception {
        if(CiReviewWindow.currentPage != 1){
            CiReviewWindow.currentPage -= 1;
            CiReviewWindow shiReviewWindow = new CiReviewWindow();
            shiReviewWindow.showWindow();
